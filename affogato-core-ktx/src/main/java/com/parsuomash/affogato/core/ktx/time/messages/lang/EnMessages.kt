...
internal object EnMessages : LookupMessages {
  ...
  override fun aboutAMonth(days: Int, date: Long): String = "about a month"
  override fun months(months: Int, days: Int, date: Long): String = "$months months"
  override fun aboutAYear(year: Int, date: Long): String = "about a year"
  override fun years(years: Int, months: Int, date: Long): String = "$years years"
}
...
internal object EnShortMessages : LookupMessages {
  override fun lessThanOneMinute(seconds: Int, date: Long): String = "now"
  ...
  override fun aDay(hours: Int, date: Long): String = "~1d"
  override fun days(days: Int, hours: Int, date: Long): String = "${days}d"
  override fun aboutAMonth(days: Int, date: Long): String = "~1mo"
  override fun months(months: Int, days: Int, date: Long): String = "${months}mo"
  override fun aboutAYear(year: Int, date: Long): String = "~1y"
  override fun years(years: Int, months: Int, date: Long): String = "${years}y"
}
