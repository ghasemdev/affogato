...
internal object MnMessages : LookupMessages {
  ...
  override fun lessThanOneMinute(seconds: Int, date: Long): String = "хэдхэн мөчийн"
  override fun aboutAMinute(minutes: Int, date: Long): String = "минутын"
  override fun minutes(minutes: Int, seconds: Int, date: Long): String =
    "${toMongolian(minutes.toString())} минутын"

  override fun aboutAnHour(minutes: Int, date: Long): String = "цаг орчим"
  override fun hours(hours: Int, minutes: Int, date: Long): String =
    "${toMongolian(hours.toString())} цагийн"

  override fun aDay(hours: Int, date: Long): String = "өдрийн"
  override fun days(days: Int, hours: Int, date: Long): String =
    "${toMongolian(days.toString())} өдрийн"

  override fun aboutAMonth(days: Int, date: Long): String = "сар орчмын"
  override fun months(months: Int, days: Int, date: Long): String =
    "${toMongolian(months.toString())} сарын"

  override fun aboutAYear(year: Int, date: Long): String = "жил орчмын"
...
internal object MnShortMessages : LookupMessages {
  override fun lessThanOneMinute(seconds: Int, date: Long): String = "саяхан"
  override fun aboutAMinute(minutes: Int, date: Long): String = "${toMongolian("1")} мин"
  override fun minutes(minutes: Int, seconds: Int, date: Long): String =
    "${toMongolian(minutes.toString())} мин"

  override fun aboutAnHour(minutes: Int, date: Long): String = "~${toMongolian("1")} ц"
  override fun hours(hours: Int, minutes: Int, date: Long): String =
    "${toMongolian(hours.toString())} ц"

  override fun aDay(hours: Int, date: Long): String = "~${toMongolian("1")} ө"
  override fun days(days: Int, hours: Int, date: Long): String = "${toMongolian(days.toString())} ө"
  override fun aboutAMonth(days: Int, date: Long): String = "~${toMongolian("1")} с"
  override fun months(months: Int, days: Int, date: Long): String =
    "${toMongolian(months.toString())} с"

  override fun aboutAYear(year: Int, date: Long): String = "~${toMongolian("1")} ж"
  override fun years(years: Int, months: Int, date: Long): String =
