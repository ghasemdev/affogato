 ...
 * @param spacing the **vertical** spacing between each indicator in [PaddingValues].
...
fun VerticalPagerIndicator(
  ...
  spacing: PaddingValues = PaddingValues(vertical = 4.dp),
...
private fun VerticalPagerIndicator(
  ...
  StretchEffectOnly {
    LazyColumn(
      ...
      modifier = modifier
        .height(
          height = calculateIndicatorsHeight(
            indicatorSize = indicatorSize,
            spacing = spacing,
